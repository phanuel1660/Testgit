...
$query="SELECT adm,name,gender FROM students WHERE form=1";
$result=mysqli_query($con,$query);
?>
         <table align="center"  border="1px" style=" text-align: center; width: 600px; line-height: 40px;">
        <tr>
            <th colspan="3" style="color:lime;background-color: white;color: black">FORM ONE'S LIST</th>
        </tr>
        <t>
    ...
    <input type="button" name="btn" value="DOWNLOAD" style="float: bottom">
</div>
</body>
</html>