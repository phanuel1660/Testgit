...
mysqli_close($connect);
 ...
 if(isset($_POST['update'])){
    ...
    $PHONE = filter_input(INPUT_POST, 'PHONE');
    $SUBJECT_ID = filter_input(INPUT_POST, 'SUBJECT_ID');
    	 $sql_update="UPDATE faculty SET TEACHER_NAME='$TEACHER_NAME' WHERE TEACHER_ID=$data[0] ";
...
?>
        ...
        <tr>
            <th colspan="4" style="color:lime">RECORDS FOR ALL TEACHERS IN THE SCHOOL</th>
        </tr>
        <t>
